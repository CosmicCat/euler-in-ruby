...
for i in 0..$linesCount-1
  $grid.push(input.slice(i*$lineLength..i*$lineLength+$lineLength-1))
end

def calc_for_cell(x, y)
  adj = $vLength-1
  calc_vector(x, y, x, y+adj)
  calc_vector(x, y, x+adj, y+adj)
  calc_vector(x, y, x+adj, y)
  calc_vector(x, y, x+adj, y-adj)
  calc_vector(x, y, x, y-adj)
  calc_vector(x, y, x-adj, y-adj)
  calc_vector(x, y, x-adj, y)
...
def mainLoop
  for y in 0..$linesCount-1
    for x in 0..$lineLength-1
      calc_for_cell(x,y)
    end
  end
